   ...
   (try
      while true do
        try
          ...
          Js_of_ocaml.Firebug.console##log phr;
    ...
    with End_of_file -> ()
    | e -> 
      Js_of_ocaml.Firebug.console##log "AHHHH";
      Js_of_ocaml.Firebug.console##log e;
      Js_of_ocaml.Firebug.console##log "BAHHHH";
      Js_of_ocaml.Firebug.console##log (Printexc.to_string e); raise e);
   flush_all ()
